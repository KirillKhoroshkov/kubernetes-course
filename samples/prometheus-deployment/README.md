...
1. `kubectl patch deployments.apps prometheus-deployment --patch-file prometheus-patch-configmap.yaml` - Применить патч
...
1. `kubectl patch deployments.apps prometheus-deployment --patch-file prometheus-patch-secret.yaml` - Патч
